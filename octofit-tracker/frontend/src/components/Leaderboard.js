...
function Leaderboard() {
  ...
  useEffect(() => {
    ...
    fetch('https://solid-xylophone-p7w6xq49r5c5rr-8000.app.github.dev/api-root/leaderboard/')
      ...
      .then(async data => {
        ...
        const entriesWithUsers = await Promise.all(data.map(async entry => {
          ...
          try {
            const userResponse = await fetch(`https://solid-xylophone-p7w6xq49r5c5rr-8000.app.github.dev/api-root/users/${entry.user}/`);
